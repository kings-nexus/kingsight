...
- `/stack` → **VIEW** — display the current call stack
...
If the file exists, display it as-is. The file is already formatted for human readability. Then add a one-line summary:
