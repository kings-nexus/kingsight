...
2. **Proposal overlap**: Does this proposal overlap with another pending proposal? If yes, note which proposals overlap and whether they should be merged or sequenced.
